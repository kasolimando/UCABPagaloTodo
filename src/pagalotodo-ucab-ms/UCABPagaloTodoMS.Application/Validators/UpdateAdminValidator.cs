...
namespace UCABPagaloTodoMS.Application.Validators
{
    ...
    public class UpdateAdminValidator : AbstractValidator<UpdateAdminsCommand>
    {
        ...
        /// <remarks>
        ///     ## Parameters
        ///         - request: AdminsRequest, it has to be in the list Tipos to be accepted
        /// </remarks>
        /// <returns>Returns a bool with the result of the search</returns>
        /// 

        private static bool ValidateTipo(AdminsRequest request)
        {
