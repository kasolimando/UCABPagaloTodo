...
{
    public class PrestadorStatusUserValidationTests
    {
        ...
        public PrestadorStatusUserValidationTests()
        {
            _dbContextMock = new();

            _dbContextMock.SetupDbContextData();

            statusValidation = new PrestadorStatusUserValidation();
            transactionMock = new();
        }
        ...
        public async Task TestStatusAdmin_ShouldReturnStringEstatusTrue()
        {
            ...
            var request = new StatusUserCommand(data,new ConsumidorStatusUserValidation(), "username9");
        ...
        public async Task TestStatusAdmin_ShouldReturnStringEstatusFalse()
        {
            ...
            var request = new StatusUserCommand(data, new ConsumidorStatusUserValidation(), "username7");
